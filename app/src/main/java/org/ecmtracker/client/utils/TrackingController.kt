...
import org.ecmtracker.client.utils.ProtocolFormatter.formatRequest
import org.ecmtracker.client.utils.RequestManager.sendRequestAsync
import org.ecmtracker.client.utils.PositionProvider.PositionListener
import org.ecmtracker.client.utils.NetworkManager.NetworkHandler
import android.os.Handler
import android.os.Looper
import androidx.preference.PreferenceManager
import android.util.Log
import org.ecmtracker.client.PositionProviderFactory
...
import org.ecmtracker.client.utils.DatabaseHelper.DatabaseHandler
import org.ecmtracker.client.utils.RequestManager.RequestHandler
...
class TrackingController(private val context: Context) : PositionListener, NetworkHandler {
    ...
    private val url: String = sharedPreferences.getString(MainFragment.KEY_URL, context.getString(R.string.settings_url_default_value))!!
    ...
    private fun retry() {
        var fre =  MainFragment.sharedPreferences.getInt(MainFragment.KEY_FREQ, 1)
        log("retry", null)
        handler.postDelayed({
            if (isOnline) {
                read()
